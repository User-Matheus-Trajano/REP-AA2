        ...
        <section class="box-main-triple" aria-labelledby="Informações importantes">
          ...
          <div class="custom-box box-left-main">
            <div class="org-text-base">
              ...
              <h2>Nossa Missão</h2>
              <p>Promover a transformação de resíduos em novos recursos, por meio de tecnologias sustentáveis, educação ambiental e práticas que reduzam o impacto no meio ambiente, incentivando a economia circular.</p>
              <h2>Nossa Visão</h2>
          ...
          <div class="custom-box box-down-main">
              ...
              <div class="org-text-base">
                <div class="img-mold">
                  <img src="AA2/assets/Imgs/heartinhand.jpg" alt="Solo em formato de coração em mãos">
                </div>
